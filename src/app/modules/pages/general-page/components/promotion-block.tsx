...
import belt1 from "#images/belt1-promo.png";
import belt2 from "#images/belt2-promo.png";
      ...
      <div className="block-container">
        ...
        <div className="promotion-block__content">
          <div className="promotion-block__left">
            ...
            <span className="promotion-block__title">ВТОРАЯ ПЛЕНКА В ПОДАРОК</span>
          </div>
          <div className="promotion-block__right">
            <img src={belt2} alt="promo2" className="promotion-block__image" />
            <span className="promotion-block__title">СКИДКА НОВЫМ КЛИЕНТАМ 100%</span>
          </div>
        </div>
      </div>
    </div>
