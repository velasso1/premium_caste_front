      ...
      <div className="block-container">
        ...
        <div className="about-block__content">
          <div className="about-block__article">
            ...
            Вашего автомобиля, мотоцикла и вообще любой техники. Запоминающегося, яркого, комфортного, престижного,
            необычного. Такого, который станет образцом для подражания, где бы вы не появились. Богатый опыт работы с
            авто- и мототехникой различных марок позволяет нам с уверенностью сказать: мы воплотим Вашу мечту.
          </div>
