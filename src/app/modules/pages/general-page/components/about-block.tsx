      ...
      <div className="block-container">
        ...
        <div className="about-block__content">
          <div className="about-block__article">
            Студия создания АвтоСтиля PremiumCaste — это команда профессионалов
            и энтузиастов своего дела, главной задачей деятельности которой
            является одна, но очень многогранная цель — создание неповторимого
            образа Вашего автомобиля, мотоцикла и вообще любой техники.
            Запоминающегося, яркого, комфортного, престижного, необычного.
            Такого, который станет образцом для подражания, где бы вы не
