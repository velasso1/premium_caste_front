    ...
    <div className="about-block">
      <div className="block-container">
        ...
        <div className="about-block__content">
          <div className="about-block__article" style={{ textAlign: "justify" }}>
            Студия <span className="about-block__fact">PremiumCaste </span> — это команда профессионалов и энтузиастов своего дела.
            Мы разделяем общую страсть к автомобилям, мотоциклам и другой технике и работаем на результат.
            Не просто берёмся за сложные и нестандартные задачи, а берёмся с удовольствием.
            Ответственно и с любовью выполняем широкий спектр услуг по преображению, дооборудованию и уходу. <br /> <br />
            Мы работаем в этой сфере уже <span className="about-block__fact"> более 15 лет</span>, за это время выстроили прочные отношения с поставщиками и производителями. С нами вы можете быть уверены в подлинности и качестве используемых материалов и оборудования.
