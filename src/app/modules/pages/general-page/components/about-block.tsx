      ...
      <div className="block-container">
        ...
        <div className="about-block__content">
          <div className="about-block__article" style={{ textAlign: "justify" }}>
            ...
            Мы работаем в этой сфере уже более 15 лет, за это время выстроили прочные отношения с поставщиками и производителями. С нами вы можете быть уверены в подлинности и качестве используемых материалов и оборудования.
