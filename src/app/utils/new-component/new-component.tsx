...
export const NewPriceTable: React.FC<PriceTableProps> = ({ sections }) => (
  <>
    {sections.map((section) => (
      <TableContainer
        ...
        sx={{
          mb: 3,
          overflowX: "auto",
          backgroundColor: "#0f1014 !important",
          color: "#fff !important",
          border: "1px solid #1f222b !important",
          borderRadius: 2,
        }}
      >
        <Table
          ...
          sx={{
            ...
            "& .MuiTableCell-root": {
              backgroundColor: "#0f1014 !important",
              color: "#fff !important",
              borderBottom: "1px solid #1f222b !important",
            },
            "& th, & td": { borderBottom: "1px solid #1f222b !important" },
          }}
        >
          <TableHead>
            <TableRow>
              <TableCell
                ...
                sx={{
                  fontWeight: 700,
                  backgroundColor: "#16181f !important",
                  color: "#fff !important",
          ...
          <TableBody>
            {section.rows.map((row) => (
              <TableRow
                ...
                sx={{
                  backgroundColor: "#0f1014 !important",
                  "&:hover": { backgroundColor: "#15171f !important" },
                  "& td": {
                    color: "#fff !important",
                    borderBottomColor: "#1f222b !important",
                  },
                  "&:hover td": {
                    borderBottomColor: "#ff5000 !important",
...
//     id: "ppf-parts",
//     title:
//       'Защитные плёнки, отдельные элементы, "под ключ" — оклейка, плёнка',
//     columns: [
...
//     id: "design-print",
//     title:
//       'ДИЗАЙН — печать на плёнке, кузов, "под ключ" — оклейка, разбор/сбор, плёнка, прочие материалы',
//     columns: [
//       { id: "opt", label: "Опция" },
//       { id: "c1", label: "Класс 1" },
//       { id: "c2", label: "Класс 2" },
...
//             kind: "text",
//             label:
//               "уст/подкл линз вместо штатных линз с адаптивным механизмом / в рефлектор с доработками",
//           },
//           { kind: "price", value: 15000 },
//         ],
//       },
