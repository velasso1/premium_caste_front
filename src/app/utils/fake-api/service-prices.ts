...
export const PRICES: IPrices = {
  ...
  tinting: {
    headCols: ["Объекты", "Тонирующая плёнка", "Атермальная плёнка", "Укрепляющая плёнка", "Демонтаж плёнки"],
    data: [
  ...
  detailing: {
    ...
    data: [
      ...
      [
        { value: "Антидождь полный (все стёкла, кроме панорамы)" },
        { value: "5 000 ₽" },
        { value: "7 000 ₽" },
        { value: "9 000 ₽" },
        { value: "11 000 ₽" },
      ...
      [
        { value: "Антидождь полный - Антидождь панорама" },
        { value: "3 500 ₽" },
        { value: "3 500 ₽" },
        { value: "3 500 ₽" },
        { value: "3 500 ₽" },
...
export const samplePriceBook: PriceBook = [
  {
    ...
    subtitle:
      "ФРОНТ — бампер, капот, крылья, фары (и ПТФ, если есть); ФРОНТ+ добавляет стойки лобового, полосы на крышу, зеркала, зоны под ручками, погрузочную зону бампера/багажника",
    columns: [
      { id: "opt", label: "Опция" },
      { id: "c1", label: "Класс 1" },
      { id: "c2", label: "Класс 2" },
  ...
  {
    id: "colored-poly",
    title: "ЦВЕТНЫЕ ПОЛИУРЕТАНОВЫЕ ПЛЁНКИ, кузов, “под ключ” — оклейка, разбор/сбор, плёнка, прочие материалы",
    columns: [
      { id: "opt", label: "Опция" },
      { id: "c1", label: "Класс 1" },
      { id: "c2", label: "Класс 2" },
  ...
  {
    id: "design-print",
    title: 'ДИЗАЙН - печать на плёнке, кузов, "под ключ" - макет, оклейка, разбор/сбор, плёнка, прочие материалы',
    columns: [
      { id: "opt", label: "Опция" },
      { id: "c1", label: "Класс 1" },
      { id: "c2", label: "Класс 2" },
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        id: "polish-out",
        cells: [
          { kind: "text", label: "полировка фар, пара, снаружи" },
          { kind: "price", value: 3000 },
        ],
      },
      {
...
Работаем напрямую с поставщиками натуральной и эко-кожи, ткани и оригинальной Alcanrata`,
  ...
  Стоимость указана "под ключ" - арматурные работы по снятию/установки ремней, лент, замена ленты, сама лента, стопоры
...
Работаем напрямую с поставщиками/производителями лент и ковров.`,
  light: `В стоимость работ входят - установка и подключение оборудования, сопутствующие арматурные и прочие работы.
Приведена стоимость работ без учёта стоимости компонентов.
Стоимость оклейки указана "под ключ", с учётом плёнки.
...
Работаем напрямую с поставщиками/производителями - Optima Premium, MTF, Aozoom, Shiny Light`,
  equipment: `В стоимость работ входят - установка и подключение оборудования, сопутствующие арматурные и прочие работы.
Приведена стоимость работ без учёта стоимости компонентов.

С нами вы можете быть уверены в качестве и подлинности используемых компонентов.
Работаем напрямую с поставщиками/производителями`,
  sound: `В стоимость работ входят - установка и подключение оборудования, сопутствующие арматурные и прочие работы.
Приведена стоимость работ без учёта стоимости компонентов.
